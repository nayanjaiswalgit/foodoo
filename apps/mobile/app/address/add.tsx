...
export default function AddAddressScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Card>
        <Input label="Label" value={label} onChangeText={(v: string) => setLabel(v as typeof LABELS[number])} placeholder="Home, Work, or Other" />
        <Input label="Address Line 1 *" value={addressLine1} onChangeText={setAddressLine1} placeholder="Street address" />
        <Input label="Address Line 2" value={addressLine2} onChangeText={setAddressLine2} placeholder="Apt, floor (optional)" />
        ...
        <Input label="Pincode *" value={pincode} onChangeText={(v: string) => setPincode(v.slice(0, 6))} placeholder="6-digit pincode" keyboardType="numeric" />
        <Button
          title="Save Address"
          onPress={handleSave}
